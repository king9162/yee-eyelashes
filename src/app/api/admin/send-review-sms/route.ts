...
export async function POST(req: NextRequest) {
  ...
  const text = `Hi ${name}! Thank you for your visit at Yee Eyelashes 🌸 We'd love your feedback. Please leave us a Google review: ${reviewUrl}  📍 278 Plandome Rd, Manhasset · 516-984-3859`;
