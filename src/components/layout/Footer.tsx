    ...
    <footer>
      ...
      <div className="bg-[#F8F5EF] border-t border-neutral-200/60">
        <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            <p
              className="text-[2rem] md:text-[2.5rem] font-light text-[#1C1C1C] leading-tight mb-2"
            ...
            <div className="flex flex-col items-center">
              <Link href={`/${lang}`} className="group">
                <Image
                  ...
                  width={4000}
                  height={1340}
                  className="h-[105px] w-auto brightness-0 invert transition-opacity duration-300 group-hover:opacity-75"
                />
              </Link>
              ...
              <div className="flex justify-between mt-7 w-full">
                ...
                <a
                  ...
                  className="flex flex-col items-center gap-2 text-white/40 hover:text-[#C9A84C] transition-colors duration-300 group"
                >
            ...
            <div className="md:absolute md:left-1/2 md:-translate-x-1/2 md:top-0">
              <div className="flex flex-col gap-8 items-center text-center">
                <div>
                  ...
                  <p className="text-white/75 text-[15px] tracking-[0.02em] leading-[1.7]">
                    {contact.address}
                  </p>
                </div>
                <div>
                  ...
                  <a
                    ...
                    className="text-white/75 hover:text-[#C9A84C] text-[15px] tracking-[0.02em] transition-colors duration-300"
                  >
                    {contact.phone}
                  </a>
                </div>
