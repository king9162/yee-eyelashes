...
const FILLS_PMU: FlatItem[] = [
  ...
  { name: "Brow Lamination",      nameZh: "眉毛塑形燙翹",          isHeader: true },
  { name: "Brow Lam + Tinting + Shaping", nameZh: "燙翹 + 染色 + 修眉", price: 130, duration: "75min" },
  { name: "Brow Lam + Shaping",   nameZh: "燙翹 + 修眉", price: 110, duration: "60min" },
  { name: "Wax",                  nameZh: "蜜蠟除毛",              isHeader: true },
  { name: "Wax - Eyebrow",        nameZh: "蜜蠟 - 眉型", price: 10,  duration: "15min" },
  { name: "Wax - Cheeks",         nameZh: "蜜蠟 - 臉頰", price: 15,  duration: "15min" },
  { name: "Wax - Chin",           nameZh: "蜜蠟 - 下巴", price: 20,  duration: "15min" },
  { name: "Wax - Upper Lip",      nameZh: "蜜蠟 - 上唇", price: 10,  duration: "10min" },
  { name: "Wax - Lower Lip",      nameZh: "蜜蠟 - 下唇", price: 10,  duration: "10min" },
