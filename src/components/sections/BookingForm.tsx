          ...
          <div className="lg:pt-12">
            ...
            <div className="mt-6">
              ...
              <p className="text-[12px] text-neutral-400 leading-[1.85]">
                {zh
                  ? "請提前至少 24 小時通知取消或更改預約。多次無故缺席者，未來預約可能需繳交訂金。"
                  : "Please notify us at least 24 hours in advance for cancellations. Repeated no-shows may require a deposit for future bookings."}
              </p>
            </div>
          </div>
        </div>
