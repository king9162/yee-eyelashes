...
const categories = [
  {
    ...
    nameZh: "睫毛嫁接",
    descEn: "Precision-crafted sets in Real Mink and Premium Cashmere, each designed around your eye shape and lifestyle. From understated elegance to bold drama, every set is uniquely yours.",
    descZh: "精準打造 Real Mink 與 Premium Cashmere 款式——每一套都根據您的眼形與生活方式量身設計。從低調優雅到大膽奪目，每一副都獨一無二。",
    fromEn: "From $60",
    fromZh: "從 $60 起",
  ...
  },
  {
    ...
    nameEn: "3D Lashes",
    nameZh: "3D 豐盈睫毛",
    descEn: "Multi-layered volume lashes for a full, dramatic look. Multiple ultra-fine fans applied per natural lash for maximum density and impact. Available in Real Mink and Premium.",
    descZh: "多重豐盈嫁接，打造蓬鬆戲劇效果。每根天然睫毛接多個超細扇形，呈現最大密度與視覺衝擊。提供 Real Mink 與 Premium 兩種材質。",
    fromEn: "From $160",
    fromZh: "從 $160 起",
    durationEn: "1.5 – 2 hrs",
    durationZh: "1.5 – 2 小時",
  },
  {
    n: "03",
