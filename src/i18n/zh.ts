const zh = {
  ...
  services_preview: {
    heading: "精準睫毛藝術",
    subheading: "每一套服務都從個人諮詢開始。在接上第一根睫毛之前，我們先深入了解您的眼型、五官輪廓與理想效果，因為卓越的成果源自卓越的規劃。",
    cta: "查看所有服務",
  },
  gallery_preview: {
    heading: "YEE 品質標準",
    subheading: "從精緻自然到豐盈戲劇，每一套作品都是您個人美學的獨特詮釋，以極致細節精心打造。",
    cta: "查看完整作品集",
  },
  testimonials: {
  ...
  instagram: {
    heading: "追蹤 YEE 的美麗日常",
    subheading: "客戶蛻變記錄、睫毛藝術創作與幕後花絮",
    cta: "追蹤 @yee_lashesny",
  },
  faq: {
    heading: "您最想知道的一切",
  ...
  booking: {
    heading: "預約您的專屬時段",
    subheading: "頂級睫毛藝術，完美配合您的生活節奏。名額有限，立即預約確保您的位置。",
    note: "我們將於 24 小時內確認您的預約。",
    cta: "立即預約",
  },
  footer: {
